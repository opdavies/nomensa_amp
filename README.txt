 ...
 * Download and enable the jQuery UI module.
 ...
 * Go to /admin/settings/nomensa-amp and configure the module as required.
 * Create a node and enter the HTML link to the video.
 * The video player will automatically be loaded in place of the link.
 * For an example, go to http://drupal6.nomensa-amp.oliverdavies.co.uk.

DEMO
----

http://drupal6.nomensa-amp.oliverdavies.co.uk
